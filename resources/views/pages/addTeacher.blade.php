...
@section('body')
 <div class=" col-9 offset-1 my-5 bg-white card">
    ...
    <form action="{{route('admin#addTeacher')}}" method="POST"  class=" card-body">
...
@csrf
        ...
        <div class="form-group ">
          ...
          <div class="form-group ">
            ...
            <div class="">
                <input type="email" class=" form-control" placeholder="Enter Teacher Email" name="email">
          @error('email')
          <small class=" text-danger ">{{$message}}</small>
          @enderror
          ...
          <div class="form-group ">
            ...
            <div class="">
                <input type="number" class=" form-control" placeholder="Enter Teacher Ph Number" name="phone">
          @error('phone')
          <small class=" text-danger ">{{$message}}</small>
          @enderror
          ...
          <div class="form-group ">
            ...
            <div class="">
                <input type="address" class=" form-control" placeholder="Enter Teacher Address" name="address">
          @error('address')
          <small class=" text-danger ">{{$message}}</small>
          @enderror
